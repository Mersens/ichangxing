...
import com.cxwl.ichangxing.adapter.SQAdapter;
...
public class SQFragment extends BaseFragment {
    ...
    List<SQEntity> mList=new ArrayList<>();
    ...
    protected void initView(View view) {
        ...
        adapter=new SQAdapter(getActivity(),mList);
    ...
    protected void initData() {
        ...
        RequestManager.getInstance()
                .mServiceStore
                .getPayRecord(token,pageCurrent+"",pageSize+"")
                ...
                .subscribe(new ResultObserver(new RequestManager.onRequestCallBack() {
                    ...
                    public void onSuccess(String msg) {
                        ...
                        Log.e("getPayRecord", "getPayRecord==" + msg);
    ...
    private void analysisJson(JSONArray array) throws JSONException {
       Gson gson=new Gson();
        List<SQEntity> list=new ArrayList<>();
        for (int i = 0; i < array.length(); i++) {
            String str = array.getString(i);
            SQEntity entity=gson.fromJson(str,SQEntity.class);
            list.add(entity);
        }
        mList.addAll(list);
